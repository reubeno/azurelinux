...
Patch0:        add-ssl-copy-ca-trust-dirs-setting.patch
...
%changelog
* Thu Feb 27 2025 Reuben Olinsky <reubeno@microsoft.com> - 5.6-2
- Add patch to allow disabling ca-trust copying.
